...
.cra-logo{width:22px;height:22px;background:#244991;border-radius:6px;display:flex;align-items:center;justify-content:center}
.cra-logo svg{width:12px;height:12px}
.cra-title{font-size:13px;font-weight:600;color:#244991}
.cra-subtitle{font-size:10px;color:#6b7280}
...
.cra-us-title{font-size:12px;font-weight:600;color:#111827}
.cra-us-meta{display:flex;align-items:center;gap:6px;margin-top:3px}
.badge-ip{background:#fef3c7;color:#92400e;font-size:9px;font-weight:600;padding:2px 6px;border-radius:4px}
.cra-us-info{font-size:10px;color:#9ca3af}
...
.step-icon.done{background:#d1fae5;color:#2da44e}
.step-label{font-size:10px;font-weight:500;color:#374151;line-height:1.3}
.step-sub{font-size:9px;color:#9ca3af;margin-top:1px}
.step.active .step-sub{color:#2D9EDF}
.step.done .step-sub{color:#2da44e}
...
.checkmark{font-size:11px;color:#2da44e;font-weight:700}
...
.rc-badge{background:#fee2e2;color:#b91c1c;font-size:9px;font-weight:700;padding:3px 8px;border-radius:4px;letter-spacing:0.4px}
.rc-name{font-size:12px;font-weight:600;color:#111827;margin:5px 0 2px}
.rc-meta{font-size:10px;color:#9ca3af}
.gauge-wrap{position:relative;width:64px;height:66px;flex-shrink:0}
.gauge-wrap svg{width:64px;height:66px}
.gauge-score{position:absolute;bottom:0;left:50%;transform:translateX(-50%);font-size:18px;font-weight:700;color:#e5534b;line-height:1}
.gauge-pts{font-size:8px;color:#9ca3af;text-align:center;margin-top:1px}
.risk-factors{margin-top:10px}
.rf-title{font-size:9px;font-weight:600;color:#6b7280;letter-spacing:0.5px;text-transform:uppercase;margin-bottom:6px}
.rf-row{margin-bottom:6px}
.rf-label{display:flex;justify-content:space-between;gap:12px;font-size:10px;color:#374151;margin-bottom:3px}
.rf-pts{color:#e5534b;font-weight:600;flex-shrink:0;white-space:nowrap}
...
<div class="cra-wrap">
  <div class="cra-header">
    <div class="cra-logo"><svg viewBox="0 0 12 12" fill="none"><circle cx="6" cy="6" r="4.5" stroke="white" stroke-width="1.5"/><path d="M4 6l1.5 1.5L8 4" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
    <div><div class="cra-title">Change Risk Analyzer</div><div class="cra-subtitle">ServiceNow · v1.0</div></div>
  </div>
  ...
  <div class="result-card" id="resultCard">
    <div class="rc-top">
      <div>
        ...
        <div class="rc-meta">14 records · 3 sensitive tables · 4 rule changes · 11 ACL changes</div>
      </div>
      <div>
        ...
        <div class="gauge-pts">RISK SCORE</div>
      </div>
    </div>
